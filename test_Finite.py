...
from generate_data import generate_arm_Finite
...
seed=0
arm_start,param_start,chg_dist=generate_arm_Finite(T,K,m,seed)
...
L=['EXP3S_data','CUSUM_data','DS_UCB_data','LBSDA_data','M_UCB_data','DS_TS_data']
for i in L:
    print(i+":",eval(i)[0][-1])
